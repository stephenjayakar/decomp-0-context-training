# .text:0x0 | 0x800BE7E0 | size: 0x348
.fn ftDemo_CreateFighter, global
/* 800BE7E0 000BB3C0  7C 08 02 A6 */	mflr r0
/* 800BE7E4 000BB3C4  38 80 00 08 */	li r4, 0x8
/* 800BE7E8 000BB3C8  90 01 00 04 */	stw r0, 0x4(r1)
/* 800BE7EC 000BB3CC  38 A0 00 00 */	li r5, 0x0
...
/* 800BE800 000BB3E0  3B A3 00 00 */	addi r29, r3, 0x0
/* 800BE804 000BB3E4  38 60 00 04 */	li r3, 0x4
/* 800BE808 000BB3E8  48 2D 19 E9 */	bl GObj_Create
/* 800BE80C 000BB3EC  3C 80 80 08 */	lis r4, ftDrawCommon_80080E18@ha
/* 800BE810 000BB3F0  3B E3 00 00 */	addi r31, r3, 0x0
/* 800BE814 000BB3F4  38 84 0E 18 */	addi r4, r4, ftDrawCommon_80080E18@l
/* 800BE818 000BB3F8  38 A0 00 05 */	li r5, 0x5
/* 800BE81C 000BB3FC  38 C0 00 00 */	li r6, 0x0
...
/* 800BE838 000BB418  3B C3 00 00 */	addi r30, r3, 0x0
...
/* 800BE850 000BB430  38 7F 00 00 */	addi r3, r31, 0x0
/* 800BE854 000BB434  38 DE 00 00 */	addi r6, r30, 0x0
/* 800BE858 000BB438  38 80 00 04 */	li r4, 0x4
/* 800BE85C 000BB43C  48 2D 23 0D */	bl GObj_InitUserData
/* 800BE860 000BB440  80 7D 00 00 */	lwz r3, 0x0(r29)
/* 800BE864 000BB444  4B FC 6E C9 */	bl ftData_8008572C
/* 800BE868 000BB448  80 1D 00 00 */	lwz r0, 0x0(r29)
/* 800BE86C 000BB44C  38 7F 00 00 */	addi r3, r31, 0x0
/* 800BE870 000BB450  38 81 00 0C */	addi r4, r1, 0xc
/* 800BE874 000BB454  90 01 00 0C */	stw r0, 0xc(r1)
/* 800BE878 000BB458  88 1D 00 04 */	lbz r0, 0x4(r29)
...
/* 800BE888 000BB468  50 A0 0E 30 */	rlwimi r0, r5, 1, 24, 24
...
/* 800BE8B0 000BB490  80 BE 00 04 */	lwz r5, 0x4(r30)
...
/* 800BE8C4 000BB4A4  80 63 00 00 */	lwz r3, 0x0(r3)
...
.L_800BE910:
/* 800BE910 000BB4F0  80 7E 00 04 */	lwz r3, 0x4(r30)
...
/* 800BE924 000BB504  80 7D 00 08 */	lwz r3, 0x8(r29)
/* 800BE928 000BB508  2C 03 00 09 */	cmpwi r3, 0x9
/* 800BE92C 000BB50C  41 80 00 30 */	blt .L_800BE95C
/* 800BE930 000BB510  80 BE 00 04 */	lwz r5, 0x4(r30)
...
/* 800BE944 000BB524  81 84 00 00 */	lwz r12, 0x0(r4)
...
.L_800BE95C:
/* 800BE95C 000BB53C  2C 03 00 08 */	cmpwi r3, 0x8
...
.L_800BE974:
/* 800BE974 000BB554  2C 03 00 07 */	cmpwi r3, 0x7
...
.L_800BE98C:
/* 800BE98C 000BB56C  2C 03 00 05 */	cmpwi r3, 0x5
...
.L_800BE9A8:
/* 800BE9A8 000BB588  38 60 00 00 */	li r3, 0x0
/* 800BE9AC 000BB58C  38 00 00 09 */	li r0, 0x9
...
/* 800BEA20 000BB600  80 9E 00 04 */	lwz r4, 0x4(r30)
...
/* 800BEA34 000BB614  81 83 00 00 */	lwz r12, 0x0(r3)
/* 800BEA38 000BB618  28 0C 00 00 */	cmplwi r12, 0x0
/* 800BEA3C 000BB61C  41 82 00 10 */	beq .L_800BEA4C
/* 800BEA40 000BB620  7D 88 03 A6 */	mtlr r12
/* 800BEA44 000BB624  38 7F 00 00 */	addi r3, r31, 0x0
...
/* 800BEA70 000BB650  38 7F 00 00 */	addi r3, r31, 0x0
/* 800BEA74 000BB654  38 A0 00 01 */	li r5, 0x1
...
/* 800BEA84 000BB664  38 7F 00 00 */	addi r3, r31, 0x0
/* 800BEA88 000BB668  38 A0 00 04 */	li r5, 0x4
...
/* 800BEA98 000BB678  38 7F 00 00 */	addi r3, r31, 0x0
/* 800BEA9C 000BB67C  38 A0 00 05 */	li r5, 0x5
...
/* 800BEAAC 000BB68C  38 7F 00 00 */	addi r3, r31, 0x0
/* 800BEAB0 000BB690  38 A0 00 09 */	li r5, 0x9
...
/* 800BEAC0 000BB6A0  38 7F 00 00 */	addi r3, r31, 0x0
...
/* 800BEAD4 000BB6B4  80 9D 00 08 */	lwz r4, 0x8(r29)
...
/* 800BEAE8 000BB6C8  81 83 00 00 */	lwz r12, 0x0(r3)
/* 800BEAEC 000BB6CC  28 0C 00 00 */	cmplwi r12, 0x0
/* 800BEAF0 000BB6D0  41 82 00 10 */	beq .L_800BEB00
/* 800BEAF4 000BB6D4  7D 88 03 A6 */	mtlr r12
/* 800BEAF8 000BB6D8  38 7F 00 00 */	addi r3, r31, 0x0
